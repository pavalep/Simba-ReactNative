...
export interface AudioPlayerHookData {
  ...
  title: string;
  fileUri: string | null;
  /** Canonical media origin used by persistence, badges, and playlist routing. */
  ...
  return (
    <View
      ...
      <View style={styles.eyebrowRow}>
        <View style={[styles.eyebrowDot, {backgroundColor: isPlaying ? colors.accent.gold : colors.text.tertiary}]} />
        <AppText variant="caption" style={[styles.eyebrow, {color: colors.text.secondary}]}>
  ...
  return (
    <View style={styles.root}>
      ...
      <PlaylistPreviewSheet
        ...
        queue={h.playlist.map((e: PlaylistEntry) => ({
          fileUri: e.uri,
          title: e.title,
          source: e.source,
          type: e.type,
      ...
      <QueueSheet
        ...
        currentTrack={h.playlist.find((entry: PlaylistEntry) => entry.uri === h.currentFile) ?? null}
        queue={h.queue}
