...
// the FlatList's bottom edge (Movies parity).
...
import {createPodcastsFooterStyles} from '../styles';
...
export const PodcastsFooter: React.FC<Props> = ({
  isLoadingMore,
  hasLoaded,
  error,
  reachedEnd,
  ...
  const styles = useMemo(() => createPodcastsFooterStyles(colors), [colors]);
