// ─── Podcasts Screen — BrowseLayout ───────────────────────────────────
// v10 unified section-browse layout: every section renders the SAME
// shell — header + search + chips + content + FAB + filter sheet. The
// ONLY per-screen part is `config.renderContent`. Co-located with the
// other shell pieces (`BrowseFab`, `BrowseContent`, `useOptions`,
// `useSearch`) — the "browse" pieces used to live in a `browse/`
