// ─── Podcasts Screen — BrowseContent ──────────────────────────────────
// Generic per-screen content rendering shell (data + rows modes,
// skeletons, ErrorState/EmptyState). Co-located with `BrowseLayout`
// and `BrowseFab` — all three form the section shell siblings in
// `components/`.
