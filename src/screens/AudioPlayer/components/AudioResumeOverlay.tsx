...
export interface AudioResumeOverlayProps {
...
/**
 * 58.2: 31.2 Netflix-style resume choice for AUDIO — mirrors
 * VideoPlayerResumeOverlay: when a saved position exists, ask the user
 * "Resume from MM:SS" or "Start Over" instead of silently auto-seeking.
 * Works for local files AND streams (mpv seeks HTTP VOD the same way).
 */
export const AudioResumeOverlay: React.FC<AudioResumeOverlayProps> = ({
  position,
  onResume,
  onStartOver,
}) => {
...
export default AudioResumeOverlay;
